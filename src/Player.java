...
public class Player extends Sprite {
	...
	public Player(float x, float y, TiledMap map, Image image, float speed) throws SlickException {
	...
	public void update(int delta, Vector2f dest) {		
		...
		if(super.getPos().distance(dest)>World.MIN_DISTANCE && isSolid(nextPos)==false) {
